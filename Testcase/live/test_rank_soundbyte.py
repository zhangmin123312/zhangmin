...
import os,jsonpath
@allure.feature('抖音官方小时榜')
# @pytest.mark.flaky(reruns=5, reruns_delay=1)
class TestCase_Rank_Soundbyte():

    orderby=['user_count','follower_count']

    @allure.description("""验证抖音官方小时榜遍历所有的小时榜点是否有返回数据""")
    @allure.title("抖音官方小时榜查看榜点：{soundbyte_timestamps}")
    ...
    @allure.description("""验证抖音官方小时榜单是否会排序规则排序""")
    @pytest.mark.parametrize('orderby', orderby)
    @allure.title("抖音官方小时榜按{orderby}排序")
