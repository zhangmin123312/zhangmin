...
# @Time    : 2021/12/13
# @Author  : chenxubin
# @File    : test_authorRank_bangNew_G.py
import allure
import pytest
...
@allure.feature('成长达人榜')
@pytest.mark.flaky(reruns=5, reruns_delay=1)
class TestCase_AuthorRank_BangNew_G():

    @allure.story('验证成长达人榜日榜、周榜、月榜遍历商品大类返回的数据是否大于20条')
    ...
    def test_authorRank_bangNew_G_product_type(self, get_token, get_host, star_type, times):
